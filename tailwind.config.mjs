      ...
      typography: ({ theme }) => ({
        dracula: {
          css: {
            ...
            "--tw-prose-headings": theme("colors.dracula-orange.DEFAULT"),
            "--tw-prose-lead": theme("colors.dracula-orange.DEFAULT"),
            "--tw-prose-links": theme("colors.dracula-cyan.DEFAULT"),
            "--tw-prose-bold": theme("colors.dracula-purple.DEFAULT"),
            "--tw-prose-counters": theme("colors.dracula-orange.DEFAULT"),
            "--tw-prose-bullets": theme("colors.dracula-orange.DEFAULT"),
            "--tw-prose-hr": theme("colors.dracula-orange.DEFAULT"),
            "--tw-prose-quotes": theme("colors.dracula-light.DEFAULT"),
            "--tw-prose-quote-borders": theme("colors.dracula-orange.DEFAULT"),
            "--tw-prose-captions": theme("colors.dracula-orange.DEFAULT"),
