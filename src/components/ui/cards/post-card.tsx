...
export default function PostCard({
  ...
  const component = (
    <a href={snapshot.href} className="card-hoverable p-8 text-pretty flex flex-col gap-4">
      <h2 className="font-bold text-3xl text-dracula-orange">{snapshot.title}</h2>
